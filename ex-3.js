...
// Start coding here
let sum_Birdie_Shepland = 0;

for (let i = 0; i < orders.length; i++) {
  if (orders[i].customerName === "Birdie Shepland") {
    sum_Birdie_Shepland = orders[i].productPrice * orders[i].productQuantity;
  }
}

console.log(
  `Total paid amount of Birdie Shepland: ${sum_Birdie_Shepland} Bath`
);
